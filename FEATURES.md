...
- **Automated Logistics:**
    ...
    - **Checkout Logic:** The system understands hotel logic; "Check-out" is automatically placed on the morning *after* the final night of the stay, ensuring the departure day is correctly initialized.
- **Nested Reordering:**
...
- **Modern Aesthetics:** A professional "Zinc/Dark" theme focused on clarity and reducing eye strain during long planning sessions.
