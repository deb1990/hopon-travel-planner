  ...
  if (error) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center p-24 bg-background text-foreground">
        <h2 className="text-destructive font-bold text-xl">Trip Not Found</h2>
        <p className="text-zinc-500 text-sm mt-2">{(error as Error).message}</p>
        <Link href="/" className="mt-4 px-4 py-2 bg-zinc-800 rounded-md text-xs hover:bg-zinc-700">
          Back to Dashboard
        </Link>
      </div>
    );
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-[10px] text-muted-foreground uppercase font-medium">
                Itinerary View / Spatial-Temporal
              </p>
            </div>
          </div>
