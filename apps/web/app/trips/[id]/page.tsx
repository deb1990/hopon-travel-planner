...
export default function TripDetail() {
  ...
  if (error) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center p-24 bg-background text-foreground">
        ...
        <p className="text-slate-400 text-sm mt-2 font-medium">{(error as Error).message}</p>
        <Link
          href="/"
  ...
  return (
    <main className="flex min-h-screen flex-col bg-slate-50/50 dark:bg-black text-slate-900 dark:text-white transition-colors duration-500">
      <header className="sticky top-0 z-50 border-b border-slate-100 dark:border-white/5 bg-white/80 dark:bg-black/80 backdrop-blur-xl px-8 py-5">
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          <div className="flex items-center gap-8">
            <Link
              href="/"
              className="size-10 bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5 rounded-2xl flex items-center justify-center text-slate-400 hover:text-blue-600 hover:bg-white hover:border-blue-100 transition-all duration-300 group"
            >
          ...
          <div className="flex items-center gap-6">
            <ThemeToggle />
            <div className="flex items-center gap-2 bg-white dark:bg-white/5 px-4 py-2 rounded-full border border-slate-100 dark:border-white/5 shadow-sm">
              <div className="size-1.5 rounded-full bg-green-500 animate-pulse shadow-[0_0_8px_rgba(59,130,246,0.5)]" />
              ...
              <div className="flex flex-col">
                {baseGroups.length > 0 ? (
                      ...
                      {gaps.find((g) => g.startTime === group.stay.endTime) && (
                        <div className="mx-10 my-6 p-5 rounded-[2rem] border border-dashed border-orange-100 dark:border-orange-900/20 bg-orange-50/30 dark:bg-orange-900/5 flex items-center justify-between group">
                          <div className="flex flex-col gap-0.5">
                            ...
                            <span className="text-xs text-orange-900/40 dark:text-orange-100/40 font-medium">
                  ...
                  <div className="p-40 text-center flex flex-col items-center gap-4 bg-slate-50/30 dark:bg-white/[0.01]">
                    <div className="size-16 rounded-full bg-white dark:bg-white/5 border border-slate-100 dark:border-white/5 flex items-center justify-center mb-4">
          ...
          <div className="lg:col-span-4 flex flex-col gap-12 pt-12">
            <section className="flex flex-col gap-6">
              ...
              <div className="grid grid-cols-1 gap-5">
                <div className="bg-white dark:bg-white/[0.02] p-6 rounded-[2.5rem] border border-slate-100 dark:border-white/5 shadow-sm flex items-center justify-between group hover:border-blue-100 dark:hover:border-blue-900/50 transition-all duration-500">
                  <div className="flex flex-col gap-1">
                    <span className="text-[10px] uppercase font-black text-slate-400 dark:text-zinc-600 tracking-tight">
                      Total Duration
                    </span>
                    <span className="text-3xl font-black text-slate-900 dark:text-white">
                      05 <span className="text-xs text-blue-600/50 italic uppercase">Days</span>
                    </span>
                  </div>
                  <div className="size-14 rounded-3xl bg-slate-50 dark:bg-white/5 flex items-center justify-center group-hover:bg-blue-600 transition-all duration-500 group-hover:text-white group-hover:shadow-xl">
            ...
            <section className="flex flex-col gap-6">
              ...
              <div className="aspect-square bg-slate-100 dark:bg-white/[0.01] rounded-[4rem] border border-slate-200 dark:border-white/5 flex flex-col items-center justify-center relative overflow-hidden group shadow-inner">
                <div className="absolute inset-0 bg-white/40 dark:bg-blue-500/5 blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-1000" />
